...
<template>
  <UCard id="projects">
    ...
    <Card style="width: 25rem; overflow: hidden">
      ...
      <template #content>
        <p class="m-0">
          Stylish design featuring a Voroni lattice for fully passive cooling, fits on most FFF printers, simple to print.
        </p>
      </template>
      <template #footer>
    ...
    <Card style="width: 25rem; overflow: hidden">
      ...
      <template #content>
        <p class="m-0">
          Easily repurpose a broken iPod Shuffle 4th gen to make this cool framed teardown. Simple to print and customizable!
        </p>
      </template>
      <template #footer>
        <div class="flex gap-4 mt-1">
    ...
    <Card style="width: 25rem; overflow: hidden">
      ...
      <template #content>
        <p class="m-0">
          I've got more interesting, and stupid projects cooking, no promises on quality, but stay tuned anyway
        </p>
      </template>
      <template #footer>
        <div class="flex gap-5 mt-1">
          <Button as="a" href="https://YouTube.com/@diskettekitchen?sub_confirmation=1" label="Subscribe" class="w-full" />
        </div>
      </template>
    </Card>
